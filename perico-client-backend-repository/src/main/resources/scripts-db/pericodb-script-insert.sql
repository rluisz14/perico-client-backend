...
GO
INSERT INTO [Business].[Category]([categoryName],[categoryDescription],[categoryPriceRange],[categoryImageUrl],[categoryStatus]) VALUES('Combinados','Porqu� no es suficiente con uno solo, necesitas probar m�s','40 - 50','https://st4.depositphotos.com/1000605/21090/i/450/depositphotos_210905248-stock-photo-club-sandwich-ham-cheese.jpg','A')
GO
...
GO
INSERT INTO [Business].[Category]([categoryName],[categoryDescription],[categoryPriceRange],[categoryImageUrl],[categoryStatus]) VALUES('Cervezas','Nunca es una opci�n incorrecta','10 - 30','https://i.blogs.es/ce0c05/cervezas-varias2/450_1000.jpg','A')
GO
...
GO
INSERT INTO [Business].[Category]([categoryName],[categoryDescription],[categoryPriceRange],[categoryImageUrl],[categoryStatus]) VALUES('Estaci�n','Disfruta de nuestro productos por temporada','25 - 30','https://i0.wp.com/kronos365.com/wp-content/uploads/2022/07/ESTACION-34.jpg?fit=620%2C330&ssl=1','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Sandwiches'),'Doble Torre','Nunca es una opci�n incorrecta',30.00,18.00,100,CURRENT_TIMESTAMP,'https://www.kingarthurbaking.com/sites/default/files/styles/featured_image/public/2019-08/classic-sandwich-bread.jpg?itok=ZA2g6TUf','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Sandwiches'),'Tentaci�n','Para calmar las ganas',30.00,18.00,100,CURRENT_TIMESTAMP,'https://i.ytimg.com/vi/ZGpxea1w3fE/maxresdefault.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Sandwiches'),'Invita pe','Disfruta de la mejor combinaci�n de pan y papas',40.00,20.00,100,CURRENT_TIMESTAMP,'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/190322-ham-sandwich-horizontal-1553721016.png','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Sandwiches'),'Para ti','Porqu� no es suficiente con uno solo, necesitas probar m�s',40.00,20.00,100,CURRENT_TIMESTAMP,'https://st4.depositphotos.com/1000605/21090/i/450/depositphotos_210905248-stock-photo-club-sandwich-ham-cheese.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Enchiladas'),'Doble Torre','Nunca es una opci�n incorrecta',30.00,18.00,100,CURRENT_TIMESTAMP,'https://images-gmi-pmc.edge-generalmills.com/0798b070-1f82-4fa2-91ea-17e8175e44e3.jpg','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Enchiladas'),'Tentaci�n','Para calmar las ganas',30.00,18.00,100,CURRENT_TIMESTAMP,'https://i.blogs.es/23068c/enchiladas-verdes-rellenas-de-queso-1-/1366_2000.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Enchiladas'),'Invita pe','Disfruta de la mejor combinaci�n de pan y papas',40.00,20.00,100,CURRENT_TIMESTAMP,'https://bakeitwithlove.com/wp-content/uploads/2020/03/Shredded-Chicken-Enchiladas-lg-sq.jpg','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Enchiladas'),'Para ti','Porqu� no es suficiente con uno solo, necesitas probar m�s',40.00,20.00,100,CURRENT_TIMESTAMP,'https://t2.rg.ltmcdn.com/es/posts/6/7/1/enchiladas_de_pollo_en_salsa_44176_600.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Salchipapas'),'Doble Torre','Nunca es una opci�n incorrecta',30.00,18.00,100,CURRENT_TIMESTAMP,'https://www.teleantioquia.co/wp-content/uploads/2022/03/Inicio-otra-version-del-Salchipapa-Fest.jpg','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Salchipapas'),'Tentaci�n','Para calmar las ganas',30.00,18.00,100,CURRENT_TIMESTAMP,'https://www.infobae.com/new-resizer/bepTL0cqB7OHyC9qfZhaZdZ1hsw=/1200x900/filters:format(webp):quality(85)//cloudfront-us-east-1.images.arcpublishing.com/infobae/ZSGVRYLP4RHOXD5KYOROMWGKQE.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Salchipapas'),'Invita pe','Disfruta de la mejor combinaci�n de pan y papas',40.00,20.00,100,CURRENT_TIMESTAMP,'https://img.freepik.com/premium-photo/typical-latin-america-salchipapa-sausages-with-fries-ketchup-mustard-mayo_123827-3622.jpg?w=2000','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Salchipapas'),'Para ti','Porqu� no es suficiente con uno solo, necesitas probar m�s',40.00,20.00,100,CURRENT_TIMESTAMP,'https://www.magacin247.com/wp-content/uploads/2021/11/salchipapa.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Combinados'),'Invita pe','Disfruta de la mejor combinaci�n de pan y papas',40.00,20.00,100,CURRENT_TIMESTAMP,'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/190322-ham-sandwich-horizontal-1553721016.png','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Combinados'),'Para ti','Porqu� no es suficiente con uno solo, necesitas probar m�s',40.00,20.00,100,CURRENT_TIMESTAMP,'https://st4.depositphotos.com/1000605/21090/i/450/depositphotos_210905248-stock-photo-club-sandwich-ham-cheese.jpg','A')
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Estaci�n'),'Yo mismo soy','Disfruta de nuestro productos por temporada',30.00,18.00,100,CURRENT_TIMESTAMP,'https://i.ytimg.com/vi/RBXq7ySBLG0/maxresdefault.jpg','A')
GO
...
GO
INSERT INTO [Business].[Product]([categoryId],[productName],[productDescription],[productPrice],[productCost],[productStock],[productRegisterDate],[productImageUrl],[productStatus]) VALUES((SELECT categoryId FROM [Business].[Category] WHERE [categoryName] = 'Cervezas'),'Cusque�a de Trigo','Cerveza Cusque�a Trigo Premium Bier',10.00,7.00,100,CURRENT_TIMESTAMP,'https://swissbrothers.com/1594-large_default/cerveza-de-trigo-cuzquena-49-33cl.jpg','A')
GO
